...
intptr_t SV_GameSystemCalls( intptr_t *args ) {
	...
	case G_ENTITY_CONTACT:
		return SV_EntityContact( (float *)VMA(1), (float *)VMA(2), (const sharedEntity_t *)VMA(3), /*int capsule*/ qfalse );
	case G_ENTITY_CONTACTCAPSULE:
		return SV_EntityContact( (float *)VMA(1), (float *)VMA(2), (const sharedEntity_t *)VMA(3), /*int capsule*/ qtrue );
	case G_TRACE:
		SV_Trace( (trace_t *)VMA(1), (const float *)VMA(2), (float *)VMA(3), (float *)VMA(4), (const float *)VMA(5), args[6], args[7], /*int capsule*/ qfalse );
		return 0;
	case G_TRACECAPSULE:
		SV_Trace( (trace_t *)VMA(1), (const float *)VMA(2), (float *)VMA(3), (float *)VMA(4), (const float *)VMA(5), args[6], args[7], /*int capsule*/ qtrue );
		return 0;
